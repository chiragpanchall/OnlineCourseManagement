  ...
  <table class="table table-bordered" style="margin-top:40px;">
    ...
    <tbody>
      <tr>
        ...
        <td>Genreal</td>
        <td>4 Months</td>
        <td align="center"><a href="edit_courses.jsp"><button class="btn-success">Edit</button></a></td>
        <td align="center"><a href="edit_courses.jsp"><button class="btn-danger">Delete</button></a></td>
      </tr>
      <tr>
        <td>SAP ERP</td>
        <td>Genreal</td>
