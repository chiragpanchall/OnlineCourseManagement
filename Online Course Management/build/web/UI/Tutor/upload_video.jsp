...
<div class="content">
    ...
    <h2 align="center">Upload new Video</h2>           
    
    <div class="row" style="margin-top:50px;">
        <div class="col-sm-4">
        <h4 style="margin-left:100px;">Choose Video<h4>
        </div>
    ...
    <div class="row" style="margin-top:10px;">
        <div class="col-sm-4">
        <h4 style="margin-left:100px;">Choose Thumbnail<h4>
        </div>
        <div class="col-sm-4" style="margin-left:50px;">
      ...
      <div class="row" style="margin-top:10px;">
        <div class="col-sm-4">
        <h4 style="margin-left:100px;">Add Video Description<h4>
        </div>
